...
test('read permissions for open free channels', function (
    MemberRoles $role,
    ...
    channel_permissions(
        channel_type: ChannelTypes::OpenFree,
...
test('write permissions for open free channels', function (
    MemberRoles $role,
    PaymentStates $payment_state,
    ModerationMemberStates $moderation_state,
    bool $expected,
...
test('comment permissions for open free channels', function (
    MemberRoles $role,
    PaymentStates $payment_state,
    ModerationMemberStates $moderation_state,
    bool $expected,
