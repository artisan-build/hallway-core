...
test('read permissions for read only premium channels', function (
    MemberRoles $role,
    ...
    channel_permissions(
        channel_type: ChannelTypes::ReadOnlyPremium,
...
test('write permissions for read only premium channels', function (
    MemberRoles $role,
    PaymentStates $payment_state,
    ModerationMemberStates $moderation_state,
    bool $expected,
...
test('comment permissions for read only premium channels', function (
    MemberRoles $role,
    PaymentStates $payment_state,
    ModerationMemberStates $moderation_state,
    bool $expected,
