...
test('read permissions for announcements channels', function (
    MemberRoles $role,
    ...
    channel_permissions(
        channel_type: ChannelTypes::Announcements,
...
test('write permissions for announcements channels', function (
    MemberRoles $role,
    PaymentStates $payment_state,
    ModerationMemberStates $moderation_state,
    bool $expected,
...
test('comment permissions for announcements channels', function (
    MemberRoles $role,
    PaymentStates $payment_state,
    ModerationMemberStates $moderation_state,
    bool $expected,
