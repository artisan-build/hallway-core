...
test('read permissions for read only free channels', function (
    MemberRoles $role,
    ...
    channel_permissions(
        channel_type: ChannelTypes::ReadOnlyFree,
...
test('write permissions for read only free channels', function (
    MemberRoles $role,
    PaymentStates $payment_state,
    ModerationMemberStates $moderation_state,
    bool $expected,
...
test('comment permissions for read only free channels', function (
    MemberRoles $role,
    PaymentStates $payment_state,
    ModerationMemberStates $moderation_state,
    bool $expected,
